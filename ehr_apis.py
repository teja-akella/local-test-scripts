...
def get_doc_reference_by_patient_id(bearer_token, patient_id):
    url = f"https://ea.api.101gen.ai/ehr/DocumentReference?patient={patient_id}"
...
def get_doc_reference_by_patient_id_and_encounter_id(bearer_token, patient_id, encounter_id):
    url = f"https://ea.api.101gen.ai/ehr/DocumentReference?patient={patient_id}&encounter={encounter_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def get_doc_reference_by_patient_id_encounter_id_and_date_range(bearer_token, patient_id, encounter_id, start_date, end_date):
    url = f"https://ea.api.101gen.ai/ehr/DocumentReference?patient={patient_id}&encounter={encounter_id}&date=ge{start_date}&date=le{end_date}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def update_document_reference(bearer_token, document_id, data=None):

    url = f"https://ea.api.101gen.ai/update_ehr/DocumentReference/{document_id}"
...
def get_patient_by_id(bearer_token, patient_id):
    url = f"https://ea.api.101gen.ai/ehr/Patient/{patient_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def update_patient(bearer_token, patient_id, data=None):
    url = f"https://ea.api.101gen.ai/update_ehr/Patient/{patient_id}"
    headers = {"Authorization": f"Bearer {bearer_token}", "Content-Type": "application/json"}
...
def get_encounter_by_id(bearer_token, encounter_id):
    url = f"https://ea.api.101gen.ai/ehr/Encounter/{encounter_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def get_encounter_by_patient_id(bearer_token, patient_id):
    url = f"https://ea.api.101gen.ai/ehr/Encounter?patient={patient_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def get_encounter_by_patient_id_and_date_range(bearer_token, patient_id, start_date, end_date):
    url = f"https://ea.api.101gen.ai/ehr/Encounter?patient={patient_id}&date=ge{start_date}&date=le{end_date}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def update_encounter(bearer_token, encounter_id, data):

    url = f"https://ea.api.101gen.ai/update_ehr/Encounter/{encounter_id}"
...
def get_medication_request_by_patient_id(bearer_token, patient_id):
    url = f"https://ea.api.101gen.ai/ehr/MedicationRequest?patient={patient_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def get_medication_request_by_id(bearer_token, medication_request_id):
    url = f"https://ea.api.101gen.ai/ehr/MedicationRequest/{medication_request_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def update_medication_request(bearer_token, medication_request_id, data=None):
    url = f"https://ea.api.101gen.ai/update_ehr/MedicationRequest/{medication_request_id}"
    headers = {"Authorization": f"Bearer {bearer_token}", "Content-Type": "application/json"}
...
def get_condition_by_patient_id(bearer_token, patient_id):
    url = f"https://ea.api.101gen.ai/ehr/Condition?patient={patient_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def get_condition_by_patient_id_and_encounter_id(bearer_token, patient_id, encounter_id):
    url = f"https://ea.api.101gen.ai/ehr/Condition?patient={patient_id}&encounter={encounter_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def update_condition(bearer_token, condition_id, data=None):
    url = f"https://ea.api.101gen.ai/update_ehr/Condition/{condition_id}"
    headers = {"Authorization": f"Bearer {bearer_token}", "Content-Type": "application/json"}
...
def get_observation_by_id(bearer_token, observation_id):
    url = f"https://ea.api.101gen.ai/ehr/Observation/{observation_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def get_observation_by_patient_id(bearer_token, patient_id):
    url = f"https://ea.api.101gen.ai/ehr/Observation?patient={patient_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def get_observation_by_patient_id_and_encounter_id(bearer_token, patient_id, encounter_id):
    url = f"https://ea.api.101gen.ai/ehr/Observation?patient={patient_id}&encounter={encounter_id}"
    headers = {"Authorization": f"Bearer {bearer_token}"}
...
def update_observation(bearer_token, observation_id, data=None):
    url = f"https://ea.api.101gen.ai/update_ehr/Observation/{observation_id}"
    headers = {"Authorization": f"Bearer {bearer_token}", "Content-Type": "application/json"}
