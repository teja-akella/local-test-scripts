...
def test_create_binary_and_verify(get_bearer_token):
    bearer_token = get_bearer_token
    # Create binary data
    binary_data = {
        "resourceType": "Binary",
    ...
    # Create the binary
    created_response = create_binary(bearer_token, binary_data, base_url="https://ea.api.101gen.ai/add_ehr")
    assert created_response is not None, "Create binary failed"
...
def test_create_order_test_and_verify(get_bearer_token):
    bearer_token = get_bearer_token
    ...
    created_response = create_order_test(bearer_token, order_test_data, base_url="https://ea.api.101gen.ai/add_ehr")
...
def test_create_document_reference_and_verify(get_bearer_token):
    bearer_token = get_bearer_token
    ...
    created_response = ehr_apis.create_document_reference(bearer_token, doc_data, base_url="https://ea.api.101gen.ai/add_ehr")
...
def test_create_patient_and_verify(get_bearer_token):
    bearer_token = get_bearer_token
    ...
    # Create the patient
    created_response = ehr_apis.create_patient(bearer_token, patient_data, base_url="https://ea.api.101gen.ai/add_ehr")
...
def test_create_encounter_and_verify(get_bearer_token):
    bearer_token = get_bearer_token
    ...
    created_response = ehr_apis.create_encounter(bearer_token, encounter_data, base_url="https://ea.api.101gen.ai/add_ehr")
...
def test_create_medication_request_and_verify(get_bearer_token):
    bearer_token = get_bearer_token
    ...
    created_response = ehr_apis.create_medication_request(bearer_token, med_request_data, base_url="https://ea.api.101gen.ai/add_ehr")
...
def test_create_condition_and_verify(get_bearer_token):
    bearer_token = get_bearer_token
    ...
    created_response = ehr_apis.create_condition(get_bearer_token, condition_data, base_url="https://ea.api.101gen.ai/add_ehr")
...
def test_create_observation_and_verify(get_bearer_token):
    bearer_token = get_bearer_token
    ...
    created_response = ehr_apis.create_observation(get_bearer_token, observation_data, base_url="https://ea.api.101gen.ai/add_ehr")
